...
export async function buildSegmentClip(opts: {
  ...
  // Captions never wrapped before — any line longer than ~30 chars ran off
  // both edges of the 1080px-wide frame instead of breaking onto more lines.
  const caption = escapeDrawtext(wrapForDrawtext(captionText, 32));
